...
public class LoadDemoData implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		User user1 = userRepository
				.save(User.builder().role(UserRole.admin.name()).password("123456").fullName("Administrator").mobile("123456789")
				.email("admin@garage.com").build());
		User user2 = userRepository
				.save(User.builder().role(UserRole.mechanic.name()).password("123456").fullName("Mechanic-1").mobile("123456789")
				.email("mechanic-1@garage.com").build());
		User user3 = userRepository
				.save(User.builder().role(UserRole.mechanic.name()).password("123456").fullName("Mechanic-2").mobile("123456789")
				.email("mechanic-2@garage.com").build());
		User user4 = userRepository
				.save(User.builder().role(UserRole.customer.name()).password("123456").fullName("Customer-3").mobile("123456789")
				.email("mechanic-3@garage.com").build());
		User user5 = userRepository
				.save(User.builder().role(UserRole.customer.name()).password("123456").fullName("Customer-1").mobile("123456789")
				.email("Customer-1@garage.com").build());
		User user6 = userRepository
				.save(User.builder().role(UserRole.customer.name()).password("123456").fullName("Customer-2").mobile("123456789")
				.email("Customer-2@garage.com").build());
		User user7 = userRepository
				.save(User.builder().role(UserRole.customer.name()).password("123456").fullName("Customer-3").mobile("123456789")
				.email("Customer-3@garage.com").build());
